...
Route::group(["prefix" => "cajas"], function () {
    ...
    // Permisos P3: CRUD de cajas / apertura-cierre / egresos, cada uno con su permiso.
    Route::group(["prefix" => "cajas", 'middleware' => 'can:cajas.ver'], function () {
    ...
    Route::group(["prefix" => "movimientos", 'middleware' => 'can:cajas.abrir_cerrar'], function () {
    ...
    Route::group(["prefix" => "egresos", 'middleware' => 'can:cajas.egresos'], function () {
