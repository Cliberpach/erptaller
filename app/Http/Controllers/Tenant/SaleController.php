...
class SaleController extends Controller
{
    ...
    /**
     * PASO 4 - Pago en la venta (Capa B): cuentas asociadas a un método (combo dependiente).
     * Lee el pivote payment_method_accounts ya existente. EFECTIVO -> 0 cuentas (sin combo).
