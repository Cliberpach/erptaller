 <div class="container">
     ...
     <div class="row">
         ...
         <div class="col-xxl-9">
             ...
             <div class="row">
                 <div class="col-6 col-md-4 col-lg">
                     <div class="card bg-secondary bg-opacity-05 border-0 shadow-none">
                         <div class="card-body">
                             <div class="avatar bg-secondary shadow-secondary rounded-circle mb-3 text-white">
                 ...
                 <div class="col-6 col-md-4 col-lg">
                     <div class="card bg-info bg-opacity-05 border-0 shadow-none">
                         <div class="card-body">
                             <div class="avatar bg-info shadow-info rounded-circle mb-3 text-white">
                 ...
                 <div class="col-6 col-md-4 col-lg">
                     <div class="card bg-secondary bg-opacity-05 border-0 shadow-none">
                         <div class="card-body">
                             <div class="avatar bg-warning shadow-warning rounded-circle mb-3 text-white">
                 ...
                 <div class="col-6 col-md-6 col-lg">
                     <div class="card bg-success bg-opacity-05 border-0 shadow-none">
                         <div class="card-body">
                             <div class="avatar bg-success shadow-success rounded-circle mb-3 text-white">
                 ...
                 <div class="col-12 col-md-6 col-lg">
                     <div class="card bg-danger bg-opacity-05 border-0 shadow-none">
                         <div class="card-body">
                             <div class="avatar bg-danger shadow-danger rounded-circle mb-3 text-white">
         ...
         <div class="col-xxl-3">
             <div class="card z-1 overflow-hidden">
                 <div class="card-body">
                     <div class="w-75">
                         <h6 class="card-title">Create Announcement</h6>
                         <p>Make a announcement to your employee</p>
                     </div>
                     <img src="assets/images/media/svg/media1.svg" alt=""
                         class="position-absolute z-n1 bottom-0 end-0">
                 </div>
                     ...
                     <div class="row align-items-center">
                         ...
                         <div class="col-sm-6">
                             <div class="d-grid gap-2">
                                 <div class="d-flex align-items-center mx-1 gap-1">
         ...
         <div class="col-xxl-8 col-lg-7">
             <div class="card overflow-hidden">
                 <div
                     class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3 border-0 pb-0">
                     <h6 class="card-title mb-0">Employee’s Leave</h6>
                     <div id="dt_EmployeeLeave_Search"></div>
                 </div>
                 <div class="card-body gradient-layer px-3 pb-0 pt-2">
                     <table id="dt_EmployeeLeave" class="display table-row-rounded table">
         ...
         <div class="col-xxl-3 col-md-6">
             <div class="card">
                 ...
                 <div class="card-body d-flex align-items-center justify-content-center px-3 py-0">
                     <div class="maxw-250px ratio ratio-1x1">
                     ...
                     <ul class="list-group list-group-hover list-group-smooth list-group-space-sm">
                         <li class="list-group-item d-flex justify-content-between align-items-center">
                             <div class="me-auto">
                                 ...
                                 <small class="fw-medium text-body d-block">Member <span
                                         class="text-primary">03</span>
                                 </small>
                             </div>
             ...
             <div class="card-group overflow-hidden">
                 <div class="card">
                     ...
                     <div class="card-body p-3">
                         <input type="text" class="form-control d-none flatpickr-inline-custom"
                             placeholder="Select Date.." id="dateTimeFlatpickr">
                     </div>
                 </div>
                 <div class="card">
                     <div class="card-body gradient-layer" style="height: 325px;" data-simplebar>
                         <div class="bg-light mb-2 rounded bg-opacity-50 p-3">
                             <div class="d-flex align-items-center justify-content-between">
                                 <h6 class="mb-0">Team Stand Up</h6>
                                 <div class="clearfix d-flex align-items-center">
                                     <div class="btn-group">
                                         <button
                                             class="btn btn-action-dark btn-sm btn-icon waves-effect dropdown-toggle"
                                             type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                             <i class="fi fi-rr-menu-dots"></i>
                                         </button>
                                         <ul class="dropdown-menu dropdown-menu-end">
                             ...
                             <div class="text-2xs d-flex align-items-center gap-1">
                                 <img src="assets/images/icons/google-meet.svg" alt="">
                                 <span>On Google Meet</span>
                             </div>
                             <div class="d-flex justify-content-between align-items-center mt-3">
                                 <span class="badge fw-semibold bg-white text-black">Marketing</span>
                         ...
                         <div class="bg-light mb-2 rounded bg-opacity-50 p-3">
                             <div class="d-flex align-items-center justify-content-between">
                                 ...
                                 <div class="clearfix d-flex align-items-center">
                                     <div class="btn-group">
                                         <button
                                             class="btn btn-action-dark btn-sm btn-icon waves-effect dropdown-toggle"
                                             aria-label="Meeting options menu" type="button"
                             ...
                             <div class="d-flex justify-content-between align-items-center mt-3">
                                 <span class="badge fw-semibold bg-white text-black">Manager</span>
                                 <span class="text-primary text-2xs fw-semibold d-flex align-items-center">
                                     <i class="fi fi-rr-clock-three me-1"></i> 06:00 - 07:00
                                 </span>
                             </div>
                         ...
                         <div class="bg-light mb-2 rounded bg-opacity-50 p-3">
                             ...
                             <div class="d-flex justify-content-between align-items-center mt-3">
                                 <span class="badge fw-semibold bg-white text-black">HR</span>
                                 <span class="text-primary text-2xs fw-semibold d-flex align-items-center">
                                     <i class="fi fi-rr-clock-three me-1"></i> 06:00 - 07:00
                                 </span>
                             </div>
         ...
         <div class="col-lg-5">
             <div class="card">
                 ...
                 <div class="card-body px-2 pb-2 pt-0">
                     <table class="table-sm table-borderless table-row-rounded mb-0 table">
                         <thead class="table-light">
                             <tr>
                                 <th>Name</th>
                                 <th>Score</th>
             ...
             <div class="card">
                 <div class="card-header d-flex align-items-center justify-content-between border-0 pb-0">
                     ...
                     <a href="javascript:void(0);"
                         class="btn btn-sm btn-outline-light waves-effect btn-shadow">Download Report</a>
                 </div>
         ...
         <div class="col-xxl-7">
             <div class="card bg-gray border-0 bg-opacity-10 shadow-none">
                 <div
                     class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3 border-0 pb-0">
                     ...
                     <div class="clearfix d-flex align-items-center">
                         ...
                         <div class="dropdown">
                             <button class="btn dropdown-toggle btn-white btn-shadow waves-effect btn-sm"
                                 type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                 Last Month
                             </button>
                             <ul class="dropdown-menu">
                     ...
                     <div class="row gy-2">
                         ...
                         <div class="col-md-6">
                             <ul class="list-group list-group-smooth list-group-unlined">
                                 ...
                                 <li class="list-group-item d-flex justify-content-between align-items-center mb-2">
                                     <div class="avatar rounded-circle me-1">
                                         <img src="{{ asset('assets/images/avatar/avatar3.webp') }}"
                                             alt="">
                                     </div>
                                     <div class="me-auto ms-2">
                                         <h6 class="mb-0">Michael Davis</h6>
                                     ...
                                     <span class="badge badge-lg bg-secondary-subtle text-secondary">25 Dec
                                         2024</span>
                                 </li>
                             </ul>
                         </div>
             ...
             <div class="card">
                 <div class="card-header d-flex align-items-center justify-content-between border-0 pb-0">
                     ...
                     <div class="clearfix">
                         ...
                         <button type="button"
                             class="btn btn-sm btn-outline-light btn-shadow text-primary waves-effect ms-3"
                             data-bs-toggle="modal" data-bs-target="#todoTaskModal">
                             <i class="fi fi-rr-plus text-2xs me-1"></i> New Task
                         </button>
                     </div>
                 </div>
                 <div class="card-body overflow-auto px-2 pb-1 pt-3" style="height: 325px;" data-simplebar>
                     <ul id="todoList" class="list-group list-group-smooth list-group-unlined todo-nav">
                         <li class="list-group-item d-flex align-items-center todo-item mb-1 gap-2 py-2 pe-2 ps-3">
