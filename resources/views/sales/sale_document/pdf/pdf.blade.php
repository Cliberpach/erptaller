...
<body>
    <div class="cabecera">
        <div class="logo">
            ...
            @else
                <img src="{{ public_path() . '/assets/img/img_default.png' }}" class="img-fluid"
        ...
        <div class="comprobante">
            <div class="numero-documento">
                <p class="text-uppercase m-0 p-0">{{ $sale_document->type_sale_name }}</p>
                <p class="text-uppercase m-0 p-0">{{ $sale_document->serie . '-' . $sale_document->correlative }}</p>
            </div>
        </div>
    </div><br>
    ...
    <div class="cuerpo">
            ...
            <tbody>
                @foreach ($sale_document_detail as $item)
                    <tr>
                        ...
                        <td style="text-align: right">{{ number_format($item->quantity * $item->price_sale, 2) }}
                        </td>
                    </tr>
                @endforeach
        ...
        <br>
        <p class="text-uppercase text-cuerpo m-0 p-0">SON: <b>{{ $sale_document->legend }}</b></p>
        <p class="text-uppercase text-cuerpo m-0 p-0">CONDICIÓN: <b>{{ $sale_document->payment_condition_name }}</b></p>
