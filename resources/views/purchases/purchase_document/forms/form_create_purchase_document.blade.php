        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="input-group mb-3">
                    ...
                    <input required id="serie" name="serie" type="text" class="form-control"
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input required id="numero" name="numero" type="text"
                        class="form-control inputEnteroPositivo" placeholder="Número" aria-label="Username"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-7 col-sm-12 col-xs-12">
                                ...
                                <div class="input-group mb-3">
                                    <input id="producto" name="producto" readonly type="text"
