                ...
                <div class="col-12 bg-light rounded border p-3 shadow-sm" style="margin-bottom: 10px;">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <p class="mb-2"><span class="data-key">ID:</span> <span class="data-value"
                                    id="noteId"></span></p>
                            <p class="mb-2"><span class="data-key">Usuario Registrador:</span> <span
                                    class="data-value" id="userRecorderName"></span></p>
                            ...
                            <p class="mb-2"><span class="data-key">Creado el:</span> <span class="data-value"
                                    id="createdAt"></span></p>
                            <p class="mb-2"><span class="data-key">Actualizado el:</span> <span class="data-value"
                                    id="updatedAt"></span></p>
                            <p class="mb-2"><span class="data-key">Proveedor:</span> <span class="data-value"
                                    id="supplierName"></span></p>
                            <p class="mb-2"><span class="data-key">Documento del Proveedor:</span>
                                <span class="data-value" id="supplierDocument"></span>
                            </p>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <p class="mb-2"><span class="data-key">Condición:</span> <span class="data-value"
                                    id="condition"></span></p>
                            <p class="mb-2"><span class="data-key">Moneda:</span> <span class="data-value"
                                    id="currency"></span></p>
                            <p class="mb-2"><span class="data-key">Documento:</span> <span class="data-value"
                                    id="documentType"></span></p>
                            <p class="mb-2"><span class="data-key">Serie y Correlativo:</span> <span
                                    class="data-value" id="documentNumber"></span></p>
                            <p class="mb-2"><span class="data-key">IGV:</span> <span class="data-value"
                                    id="igv"></span></p>
                            <p class="mb-2"><span class="data-key">Subtotal:</span> <span class="data-value"
                                    id="subtotal"></span></p>
                            <p class="mb-2"><span class="data-key">Monto IGV:</span> <span class="data-value"
                                    id="amountIgv"></span></p>
                            <p class="mb-2"><span class="data-key">Total:</span> <span class="data-value"
                                    id="total"></span></p>
                            <p class="mb-0"><span class="data-key">Precios con IGV:</span>
                                <span class="data-value" id="pricesWithIgv"></span>
                            </p>
                        </div>
                    </div>
                </div>
