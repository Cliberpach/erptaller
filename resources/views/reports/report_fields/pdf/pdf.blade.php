    ...
    <div class="container">
        ...
        <table class="tbl-report-sale">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $report_field->created_at }}</td>
                    <td>{{ $report_field->date }}</td>
                    <td>{{ $report_field->field_name }}</td>
                    <td>{{ $report_field->customer_name }}</td>
                    <td>{{ $report_field->schedule_description }}</td>
                    <td>{{ $report_field->amount }}</td>
                    <td>{{ $report_field->status }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
