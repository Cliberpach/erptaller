    ...
    <div class="card border-primary mb-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <!-- Vehículo -->
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <label class="form-label fw-bold required_field">Vehículo:</label>
    ...
    <div class="card border-success mb-4 shadow-sm">
        ...
        <div class="card-body">
            <div class="row g-3 mb-3 pt-3">
                ...
                <!-- PRODUCTO -->
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <label class="form-label fw-bold required_field">Producto:</label>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <input type="text" class="form-control inputDecimalPositivo" id="product_quantity"
                        name="product_quantity" placeholder="0.00" required>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <input type="text" class="form-control inputDecimalPositivo" id="product_price"
                        name="product_price" placeholder="0.00" required>
