<form id="form_edit_service" method="POST">
    @csrf
    @method('POST')
        ...
        <div class="card-body small">
            <div class="row g-3">
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <span id="service_name_edit" class="text-muted">—</span>
                </div>

                <div class="col-12 col-sm-6 col-lg-3">
                    <p class="fw-bold mb-1"><i class="fas fa-dollar-sign text-danger me-1"></i>Precio Venta Original:
                    </p>
                    <span id="service_original_price_edit" class="text-muted">—</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input required type="text" class="form-control inputDecimalPositivo" id="service_price_edit"
                    name="service_price_edit" placeholder="Ingrese nuevo precio">
            </div>
        </div>
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input required type="text" class="form-control inputDecimalPositivo" id="service_quantity_edit"
