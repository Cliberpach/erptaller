    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div>
                    <h5 class="modal-title mb-0" id="modal_edit_color_label">Marca</h5>
                    <small class="text-muted">Editar marca.</small>
                </div>
                <button type="button" class="btn-close ms-auto" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>

            <div class="modal-body">
                @include('workshop.brands.forms.form_edit_marca')
            </div>
...
<script>
    ...
    async function openMdlEditMarca(colorId) {
        parametrosMdlEditColor.id = colorId;

        const data = await getMarca(colorId);
        if (!data) return;
    ...
    async function getMarca(colorId) {
        try {
            mostrarAnimacion1();
            toastr.clear();
            const res = await axios.get(route('tenant.taller.marcas.getMarca', colorId));
        ...
        `,
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    const res = await axios.post(route('tenant.taller.marcas.update', parametrosMdlEditColor
                        .id), formData);
