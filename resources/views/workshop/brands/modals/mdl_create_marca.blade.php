    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div>
                    <h5 class="modal-title mb-0" id="modal_crear_color_label">Marca</h5>
                    <small class="text-muted">Crear nueva marca.</small>
                </div>
                <button type="button" class="btn-close ms-auto" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>

            <div class="modal-body">
                @include('workshop.brands.forms.form_create_marca')
            </div>
...
<script>
    ...
    function eventsMdlCreateMarca() {
        document.querySelector('#form_create_color').addEventListener('submit', (e) => {
            e.preventDefault();
            registrarMarca(e.target);
        })
    }

    function registrarMarca(formCreateColor) {
        ...
        `,
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    const res = await axios.post(route('tenant.taller.marcas.store'), formData);
