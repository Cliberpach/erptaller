    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Importar Marca</h1>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        @include('brand.forms.form_import')
                    </div>
                    <div class="col-12 mt-3">
                        @include('brand.tables.tbl_import_brands')
                    </div>
                </div>
            ...
            <div
                ...
                <div>
                    ...
                    <button class="btn btn-primary" type="submit" form="formImportarMarcas">
...
<script>
    ...
    function eventsImport() {
        ...
        $('#mdlImportMarca').on('hidden.bs.modal', function() {
            $('#formImportarMarcas')[0].reset();
            destroyDataTable(dtImportMarcas);
            clearTable('tbl_import_brands');
            loadDtImport();
        });
    ...
    function loadDtImport() {
        dtImportMarcas = new DataTable('#tbl_import_brands', {
            language: {
    ...
    function importarMarcasExcel() {
        ...
        swalWithBootstrapButtons.fire({
            ...
            text: "Esta operación producirá cambios en el listado de marcas!",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    const response = await fetch(urlImportBrands, {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': token
                        },
                    ...
                    if (res.success) {
                        ...
                        if ('resultado' in res) {
                            ...
                            destroyDataTable(dtImportMarcas);
                            clearTable('tbl_import_brands');
                            paintTableImportBrands(res.resultado.listadoMarcas);
                            loadDtImport();
                        }
                        dtBrands.ajax.reload(null, false);
                    } else {
    ...
    function paintTableImportBrands(lstCategorias) {
        const tbody = document.querySelector('#tbl_import_brands tbody');
        let filas = ``;
