...
@section('content')
    @include('brand.modals.mdl_create')
    @include('brand.modals.mdl_edit')
    @include('brand.modals.mdl_import')

    <div class="card">
        <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
            <h4 class="card-title mb-2 mb-md-0">LISTA DE MARCAS</h4>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    @include('brand.tables.tbl_list_brands')
                </div>
            </div>
        </div>
    </div>
...
@section('js')
    <script>
                        ...
                        render: function(data, type, row) {
                            ...
                            return `
                                ...
                                <ul class="dropdown-menu" style="max-height: 150px; overflow-y: auto;">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0);" onclick="deleteBrand(${data.id})">
        ...
        function deleteBrand(id) {
            toastr.clear();
            let row = getRowById(dtBrands, id);
            let message = '';
