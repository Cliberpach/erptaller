...
@section('content')
    ...
    <div class="card">
        <form id="registerFieldForm" action="{{ route('tenant.campos.store') }}" method="POST">
            @csrf
            <div class="card-header d-flex justify-content-between flex-row">
                <h4 class="card-title">REGISTRAR CAMPO</h4>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 col-12">
                        <div class="form-group mb-3">
                            ...
                            <select name="type_field_id" id="type_field_id" class="form-control" style="text-transform: uppercase;">
                                @foreach ($type_fields as $type_field)
                                    <option value="{{ $type_field->id }}">{{ $type_field->description }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="number" name="day_price" id="day_price" class="form-control" required>
                    </div>
    
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <label for="night_price">Precio Noche</label>
                        <input type="number" name="night_price" id="night_price" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="form group">
                    ...
                    <textarea name="location" id="location" cols="3" rows="3" class="form-control" oninput="this.value = this.value.toUpperCase()"></textarea>
                </div>
            </div>
        </form>
    </div>
