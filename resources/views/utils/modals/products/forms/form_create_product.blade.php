    ...
    <div class="col-lg-6 col-md-6">
        <div class="row">
            <div class="col-lg-12 col-md-12 mb-3">
                ...
                <input placeholder="Nombre máximo 160 caracteres" name="name_mdlproduct" required maxlength="160" type="text"
            ...
            <div class="col-lg-6 col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input value="1" name="sale_price_mdlproduct" type="number" step="0.01" min="0"
                        class="form-control sale_price_mdlproduct" id="sale_price_mdlproduct" aria-label="Amount (to the nearest dollar)">
                </div>
            ...
            <div class="col-lg-6 col-md-6 colStockMin mb-3">
                ...
                <input value="0" name="stock_min_mdlproduct" type="number" class="form-control stock_min" min="0"
                    id="stock_min_mdlproduct" placeholder="STOCK MÍNIMO" aria-label="Username" aria-describedby="basic-addon1">
            ...
            <div class="col-lg-12 col-md-12 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input name="code_factory_mdlproduct" type="number" class="form-control code_factory_mdlproduct" id="code_factory_mdlproduct"
                        aria-label="Amount (to the nearest dollar)">
                </div>
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="input-group">
                    ...
                    <input name="code_bar_mdlproduct" type="number" class="form-control code_bar_mdlproduct" id="code_bar_mdlproduct"
                        aria-label="Amount (to the nearest dollar)">
                </div>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="row">
            <div class="col-lg-12 col-md-12 mb-3">
                ...
                <select name="category_id_mdlproduct" style="text-transform: uppercase;" id="category_id_mdlproduct"
                ...
                {{-- <a onclick="openCreatecategory_id_mdlproductModal()" class="btn btn-success">
            ...
            <div class="col-lg-12 col-md-12 mb-3">
                ...
                <select name="brand_id_mdlproduct" style="text-transform: uppercase;" id="brand_id_mdlproduct"
            ...
            <div class="col-lg-12 col-md-12 mb-3">
                <div class="form-group">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <input id="image_mdlproduct" name="image_mdlproduct" class="form-control form-control-sm mr-2"
