...
<script>
    ...
    function actualizarItem(dataFormEdit){
        ...
        lstNoteIncome[indiceProducto].quantity   =   dataFormEdit.cantidad;
        return true;
    }
    ...
    function setProducto(producto_id){
        ...
        const productoIndice    =   lstNoteIncome.findIndex((lcd)=>{
            return lcd.product_id == producto_id;
        })
        ...
        const producto_find   =   lstNoteIncome[productoIndice];
